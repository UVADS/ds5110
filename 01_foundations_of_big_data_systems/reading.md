...
Jupyter Notebooks are an excellent tool for including rich text and code in a single document. Since code can be run from the notebook, it is useful for instruction, demos, and debugging code. After this reading assignment, you will better understand Jupyter Notebooks, how to work with them, and how to create your own.
