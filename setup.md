...
| Tool  | Purpose  |  
|---|---|
| [Rivanna]([https://rivanna-portal.hpc.virginia.edu/pun/sys/dashboard/batch_connect/sessions](https://shibidp.its.virginia.edu/idp/profile/SAML2/Redirect/SSO?execution=e1s2))  |  All Spark computing can be done here. Required modules are installed via containers. |    
